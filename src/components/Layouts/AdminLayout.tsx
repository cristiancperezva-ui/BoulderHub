  ...
  return (
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column' as const }}>
      <header style={{
        ...
        background: 'var(--color-bg-surface)', position: 'sticky' as const, top: 0, zIndex: 50,
      }}>
      ...
      <div style={{ display: 'flex', flex: 1 }}>
        <aside style={{
          width: 220, borderRight: '1px solid var(--color-border-subtle)',
          background: 'var(--color-bg-surface)', padding: '1rem 0',
          ...
          <div style={{
            ...
            <nav style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <button onClick={() => { handleSignOut(); setMobileOpen(false); }} style={{
                ...
                fontSize: '1rem', textAlign: 'left' as const,
              }}>
